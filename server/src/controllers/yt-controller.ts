...
const ytController = ({ strapi }: { strapi: Core.Strapi }) => ({
  ...
  // POST /api/ai-sdk-yt-embeddings/yt/ingest
  async ingest(ctx: any) {
    try {
      ...
      const transcript = await strapi.documents('plugin::ai-sdk-yt-transcripts.transcript' as any)
  ...
  // GET /api/ai-sdk-yt-embeddings/yt/videos
  ...
  // GET /api/ai-sdk-yt-embeddings/yt/videos/:videoId
  ...
  // DELETE /api/ai-sdk-yt-embeddings/yt/videos/:videoId
  ...
  // GET /api/ai-sdk-yt-embeddings/yt/search?q=...&limit=5&videoId=...&topics=RAG,MCP
  ...
  // GET /api/ai-sdk-yt-embeddings/yt/videos/:videoId/chunks?start=60&end=120
  ...
  // POST /api/ai-sdk-yt-embeddings/yt/recompute
